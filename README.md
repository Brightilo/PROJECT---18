...
* }
*  
*  Configure S3 backend in main.tf file terraform {
*   backend "s3" {
*     bucket         = "dev-terraform-bucket"
...
* In the root directory of your Terraform project, replace the contents of your main.tf file to use modules. module "compute" {
...
* To use outputs from a module, specify the module name and the name of the output variable described in your output. module.compute.instance_ipv4
*   Create module blocks for each resource you need to create. 

* Final main.tf file: provider "aws" {
*   region = "us-east-1"
* }
* module "network" {
